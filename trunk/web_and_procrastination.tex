...
prioriteta ili potrebe da promislimo o dijelovima prije donošenja konačne odlike
...
i razmišljanja o nekoj temi mogu ju učiniti nezanimljivom i neprivlačnom,
...
U velikom broju situacija, osoba mora odlučiti ne samo kad da obavi zadatak već
i koji zadatak da obavi ili koliko truda mora uložiti na odabrani zadatak.
...
preteški za nas. Takvi poslovi se još nazivaju i mentalne planine \engl{mental
mountains}.
...
% TODO: Napisati uvod i većinu poglavlja.
% Ja sam samo napisao jedan dio vezan uz postojanje više opcija. Jednostavno
% nisam izdržao jer mi je ovo bila temeljna priča za smišljanje teme ;)

Prokrastiniranje radi postojanja više opcija je posebno izraženo na zadatcima
koji se izvršavaju na Internetu. Radi brojnosti stvaratelja sadržaja, Internet
nudi veliku količinu informacija i brojnost oblika prezentacije istih. Brojnost
oblika prezentacije dovodi do neodlučnosti pri odabiru, a time i do
prokrastinacije.
